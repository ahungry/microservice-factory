...
;;;; microservice-factory.run.tests.lisp

(in-package #:cl-user)

(defpackage microservice-factory.run.tests
  (:use :cl
        :microservice-factory.lib.stub
        :af.lib.ansi-colors
        :af.lib.coverage
        :af.lib.testy)
  (:export :main))

(in-package #:microservice-factory.run.tests)

(defparameter *base-directory* (asdf:system-source-directory :microservice-factory))
...
(defun test ()
  "Begin the tests!"
    ...
    (if (suite
         "microservice-factory.lib"

         (desc
          "microservice-factory.lib.stub"

          (it "Should echo the input"
              (eq 3 (microservice-factory.lib.stub:echo 3)))
          )
         ) ;; end suite
...
(defun coverage ()
  ...
  (af.lib.coverage:with-coverage :microservice-factory
    (test)
    (terpri)
...
;;; "microservice-factory.run.tests" goes here. Hacks and glory await!
